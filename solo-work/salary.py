...
class Pracownik:
    def __init__(self, imie, nazwisko, wynagrodzenie_brutto):
        ...
        # self.skladka_zdrowotna = (self.wynagrodzenie_brutto - (self.skladka_rentowa_prcw + self.skladka_emerytalna_prcw
        #                                                        + self.skladka_chorobowa)) * 0.09
    ...
    def oblicz_koszty_pracownika(self):
        koszty_pracownik = self.skladka_rentowa_prcw + self.skladka_emerytalna_prcw + self.skladka_zdrowotna + self.skladka_chorobowa
    ...
    def oblicz_koszty_pracodawcy(self):
        ...
        koszty_pracodawcy = skladka_rentowa_prcd + skladka_emerytalna_prcd + fundusz_pracy + fgsp + skladka_wypadkowa
    ...
    def oblicz_netto(self):
        ...
        return self.wynagrodzenie_brutto - koszty_pracownik - ubezpieczenie_zdrowotne - zaliczka_pod_doch
...
pracownicy[3].set_koszty_uzysk_przych(0)
...
pracownicy[3].set_kwota_wolna(150)
pracownicy[4].set_kwota_wolna(100)
